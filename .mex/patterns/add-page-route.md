...
- **Listing page** → `src/pages/blog.astro` (calls
  [`getAllPosts()`](mex://function:c4240932d9e3eb02294699461d780cb6))
- **Dynamic listing** → `src/pages/[category]/index.astro` (hardcoded `getStaticPaths()`
  plus a `categoryInfo` map)
