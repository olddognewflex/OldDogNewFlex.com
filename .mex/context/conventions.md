...
- **Components: PascalCase**, matching the filename — `BlogCard.astro`, `ThemePills.astro`,
...
// Wrong — a .tsx that renders a div and nothing else
...
- [ ] `pnpm test` passes (`tests/blog.test.ts` covers `getPostUrl`).
